...
then
  echo "	<DisjointClasses>" >> temp.owl
  echo "    	<Class IRI='#B7'/>" >> temp.owl
  echo "		<Class IRI='#B8'/>" >> temp.owl
  echo "	</DisjointClasses>" >> temp.owl
elif [[ $1 -eq 4 ]]
then
...
do
	...
	then
	  ...
	  ../bundle.sh -r pellet -m owlexp -t 10m -wi --instance "http://www.semanticweb.org/riccardo/ontologies/2017/5/untitled-ontology-3#x","http://www.semanticweb.org/riccardo/ontologies/2017/5/untitled-ontology-3#B8" file:temp.owl &>> res_bundle_inc.txt
	fi
done
