...
do
	...
	then
	  ...
	  ../bundle.sh -r pellet -m glass -t 10m -wi --instance "http://www.semanticweb.org/riccardo/ontologies/2017/5/untitled-ontology-3#x","http://www.semanticweb.org/riccardo/ontologies/2017/5/untitled-ontology-3#B8" file:temp.owl &>> res_bundle_inc.txt
	fi
done
