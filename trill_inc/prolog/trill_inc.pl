...
:- module(trill_inc,[sub_class/2, sub_class/3, prob_sub_class/3, sub_class/4, all_sub_class/3,
...
% COMMENT: some changes here to handle justifications for query and inconsistency
...
find_explanations(M,QueryType,QueryArgs,Expl,QueryOptions):-
  ...
  ( query_option(QueryOptions,time_limit,MonitorTimeLimit) ->
    trill_inc:find_n_explanations_time_limit(M,QueryType,QueryArgs,Expl,MonitorNExpl,MonitorTimeLimit,Opt)
    ;
    trill_inc:find_n_explanations(M,QueryType,QueryArgs,Expl,MonitorNExpl,Opt)
  ).
...
add_q(M,sc,Tableau0,[SubClassEx,SupClassEx],Tableau):- !,
  ...
  utility_translation_inc:add_kb_atoms(M,class,[intersectionOf([SubClassEx,NSupClassEx])]), % This is necessary to correctly prune expansion rules
...
% COMMENT: standard query probability computation. For query with no inconsistency
...
unload_all_algorithms :-
  ...
  unload_file(library(trill_internal_inc)).

set_algorithm(M:trill):-
  unload_all_algorithms,
  consult(library(trill_internal_inc)),
  clean_up(M),!.
...
init_trill(Alg):-
  utility_translation_inc:get_module(M),
  set_algorithm(M:Alg),
  set_up(M),
  trill_inc:add_kb_prefixes(M:[('disponte'='http://ml.unife.it/disponte#'),('owl'='http://www.w3.org/2002/07/owl#')]).
...
sandbox:safe_primitive(trill_inc:get_var_n(_,_,_,_,_)).
...
/*
sandbox:safe_primitive(trill_inc:sub_class(_,_)).
sandbox:safe_primitive(trill_inc:sub_class(_,_,_)).
sandbox:safe_primitive(trill_inc:prob_sub_class(_,_,_)).
sandbox:safe_primitive(trill_inc:instanceOf(_,_)).
sandbox:safe_primitive(trill_inc:instanceOf(_,_,_)).
sandbox:safe_primitive(trill_inc:prob_instanceOf(_,_,_)).
sandbox:safe_primitive(trill_inc:property_value(_,_,_)).
sandbox:safe_primitive(trill_inc:property_value(_,_,_,_)).
sandbox:safe_primitive(trill_inc:prob_property_value(_,_,_,_)).
sandbox:safe_primitive(trill_inc:unsat(_)).
sandbox:safe_primitive(trill_inc:unsat(_,_)).
sandbox:safe_primitive(trill_inc:prob_unsat(_,_)).
sandbox:safe_primitive(trill_inc:inconsistent_theory).
sandbox:safe_primitive(trill_inc:inconsistent_theory(_)).
sandbox:safe_primitive(trill_inc:prob_inconsistent_theory(_)).
sandbox:safe_primitive(trill_inc:axiom(_)).
sandbox:safe_primitive(trill_inc:add_kb_prefix(_,_)).
sandbox:safe_primitive(trill_inc:add_kb_prefixes(_)).
sandbox:safe_primitive(trill_inc:add_axiom(_)).
sandbox:safe_primitive(trill_inc:add_axioms(_)).
sandbox:safe_primitive(trill_inc:load_kb(_)).
sandbox:safe_primitive(trill_inc:load_owl_kb(_)).
*/

:- multifile sandbox:safe_meta/2.

sandbox:safe_meta(trill_inc:sub_class(_,_),[]).
sandbox:safe_meta(trill_inc:sub_class(_,_,_),[]).
sandbox:safe_meta(trill_inc:sub_class(_,_,_,_),[]).
sandbox:safe_meta(trill_inc:all_sub_class(_,_,_),[]).
sandbox:safe_meta(trill_inc:prob_sub_class(_,_,_),[]).
sandbox:safe_meta(trill_inc:instanceOf(_,_),[]).
sandbox:safe_meta(trill_inc:instanceOf(_,_,_),[]).
sandbox:safe_meta(trill_inc:instanceOf(_,_,_,_),[]).
sandbox:safe_meta(trill_inc:all_instanceOf(_,_,_),[]).
sandbox:safe_meta(trill_inc:prob_instanceOf(_,_,_),[]).
sandbox:safe_meta(trill_inc:property_value(_,_,_),[]).
sandbox:safe_meta(trill_inc:property_value(_,_,_,_),[]).
sandbox:safe_meta(trill_inc:property_value(_,_,_,_,_),[]).
sandbox:safe_meta(trill_inc:all_property_value(_,_,_,_),[]).
sandbox:safe_meta(trill_inc:prob_property_value(_,_,_,_),[]).
sandbox:safe_meta(trill_inc:unsat(_),[]).
sandbox:safe_meta(trill_inc:unsat(_,_),[]).
sandbox:safe_meta(trill_inc:unsat(_,_,_),[]).
sandbox:safe_meta(trill_inc:all_unsat(_,_),[]).
sandbox:safe_meta(trill_inc:prob_unsat(_,_),[]).
sandbox:safe_meta(trill_inc:inconsistent_theory,[]).
sandbox:safe_meta(trill_inc:inconsistent_theory(_),[]).
sandbox:safe_meta(trill_inc:inconsistent_theory(_,_),[]).
sandbox:safe_meta(trill_inc:all_inconsistent_theory(_),[]).
sandbox:safe_meta(trill_inc:prob_inconsistent_theory(_),[]).
sandbox:safe_meta(trill_inc:axiom(_),[]).
sandbox:safe_meta(trill_inc:kb_prefixes(_),[]).
sandbox:safe_meta(trill_inc:add_kb_prefix(_,_),[]).
sandbox:safe_meta(trill_inc:add_kb_prefixes(_),[]).
sandbox:safe_meta(trill_inc:remove_kb_prefix(_,_),[]).
sandbox:safe_meta(trill_inc:remove_kb_prefix(_),[]).
sandbox:safe_meta(trill_inc:add_axiom(_),[]).
sandbox:safe_meta(trill_inc:add_axioms(_),[]).
sandbox:safe_meta(trill_inc:load_kb(_),[]).
sandbox:safe_meta(trill_inc:load_owl_kb(_),[]).
sandbox:safe_meta(trill_inc:set_tableau_expansion_rules(_,_),[]).

:- use_module(library(utility_translation_inc)).

user:term_expansion((:- trill),[]):-
  utility_translation_inc:get_module(M),
  set_algorithm(M:trill),
  set_up(M),
  utility_translation_inc:set_up_kb_loading(M),
  trill_inc:add_kb_prefixes(M:[('disponte'='http://ml.unife.it/disponte#'),('owl'='http://www.w3.org/2002/07/owl#')]).
